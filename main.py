...
ADIF_FILE = './ADIF/lotwreport.adi'
BLUE_MARBLE_IMAGE = './Images/NASA Blue Marble Jun Topo Bathy.jpg'
OUTPUT_FILE = './Maps/qso_map.png'
MY_GRID = 'OJ11' #specify your location, 4 or 6 digit grid locator
SAT_ONLY = False
